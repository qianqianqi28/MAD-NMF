...
lambdamax = 1;
Regs = [5, lambdamax];
% [S_max, A_max, ~] = MAD_NMF(X, r, MaxIter, Reps, Regs);
[S_max, A_max, A] = MAD_NMF_SimplexProj(X, r, MaxIter, Reps, Regs);
S_max = S_max';
A_max = A_max';
...
exportgraphics(gcf,'plots/twodatatrueems.pdf','ContentType','vector');
...
exportgraphics(gcf,'plots/twodataminems.pdf','ContentType','vector');
...
xlim([0 1])
ylim([0 1])
exportgraphics(gcf,'plots/twodataminabundances.pdf','ContentType','vector');
...
ylabel("Volume content", 'FontSize', 26, 'FontWeight', 'bold');
legend([h1(1), h2(1), h3(1)], {'True EMs', "Esti. EM 1", "Esti. EM 2"}, 'FontSize', 16)
exportgraphics(gcf,'plots/twodatamaxems.pdf','ContentType','vector');
...
xlim([0 1])
ylim([0 1])
exportgraphics(gcf,'plots/twodatamaxabundances.pdf','ContentType','vector');
